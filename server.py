#!/usr/bin/env python3
"""Secure task delegation. — MEOK AI Labs."""
...
mcp = FastMCP("agent-delegation", instructions="MEOK AI Labs — Secure task delegation.")
_store = []

@mcp.tool()
def delegate_task(from_agent: str, to_agent: str, task: str) -> str:
...
@mcp.tool()
def verify_result(delegation_id: str, result_data: str) -> str:
    """Process and verify."""
    if err := _rl(): return err
